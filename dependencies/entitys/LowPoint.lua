...
function class:new(_base)
    ...
    function this:render()
        ...
        if z > 0 then
            _base:get('renderManager'):pushLine(x, y, x, y - 50, 3, '0x' .. private:getAlpha() .. private:getColor())
            _base:get('renderManager'):pushPoint(x, y - 10, 20, 20, 3, 180, '0x' .. private:getAlpha() .. private:getColor())
        end
    end
