            ...
            ['args'] = {
                ...
                'ShopingHelper_langs',
                {
                    ['rus'] = {
                        ...
                        ['system_regex_dialog_shop_id_find'] = '^Ћавка є%d+$',
                        ['system_regex_dialog_shop_id_match'] = '^Ћавка є(%d+)$',

                        ['message_ad_push'] = '/findilavka #1# #2#',
                        ['message_ad_push_central_market'] = '/findilavka #1# (÷–) #2#',
                        ['message_ad_next_push_time'] = '{white}—ледующа€ реклама будет показана через {orange}#1# {white}минут',
